 ...
 * <ul>
 *   <li>{@link co.edu.uniandes.miso4202.ehicletax.vtdsl.impl.PagoImpl#getPropiedades <em>Propiedades</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PagoImpl extends EntidadImpl implements Pago
{
  /**
  ...
  {
    return VtdslPackage.Literals.PAGO;
  }
  ...
  public EList<Atributo> getPropiedades()
  {
    if (propiedades == null)
    {
      propiedades = new EObjectContainmentEList<Atributo>(Atributo.class, this, VtdslPackage.PAGO__PROPIEDADES);
    }
    return propiedades;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case VtdslPackage.PAGO__PROPIEDADES:
