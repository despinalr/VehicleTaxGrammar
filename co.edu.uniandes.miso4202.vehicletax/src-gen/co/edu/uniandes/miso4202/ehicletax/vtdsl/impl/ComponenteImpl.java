 ...
 * <ul>
 *   <li>{@link co.edu.uniandes.miso4202.ehicletax.vtdsl.impl.ComponenteImpl#getName <em>Name</em>}</li>
 *   <li>{@link co.edu.uniandes.miso4202.ehicletax.vtdsl.impl.ComponenteImpl#getComponentes <em>Componentes</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ComponenteImpl extends MinimalEObjectImpl.Container implements Componente
{
  ...
  {
    return VtdslPackage.Literals.COMPONENTE;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, VtdslPackage.COMPONENTE__NAME, oldName, name));
  }
  ...
  public EList<Componente> getComponentes()
  {
    if (componentes == null)
    {
      componentes = new EObjectContainmentEList<Componente>(Componente.class, this, VtdslPackage.COMPONENTE__COMPONENTES);
    }
    return componentes;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case VtdslPackage.COMPONENTE__COMPONENTES:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case VtdslPackage.COMPONENTE__NAME:
        return getName();
      case VtdslPackage.COMPONENTE__COMPONENTES:
